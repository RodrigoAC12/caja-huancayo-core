-- ============================================================
-- Carga inicial Caja Huancayo Core
-- Contraseñas:
...
('10000000-0000-0000-0000-000000000002','00000000-0000-0000-0000-000000000002','0002','pbkdf2_sha256$260000$cmac_1234_2026$nhlxp2cx5uXJUEw0lgBkJ8tOY/jREMA0+ZGJZphlOGo=','personal'),
('10000000-0000-0000-0000-000000000003','00000000-0000-0000-0000-000000000003','0001','pbkdf2_sha256$260000$cmac_1234_2026$nhlxp2cx5uXJUEw0lgBkJ8tOY/jREMA0+ZGJZphlOGo=','personal'),
('10000000-0000-0000-0000-000000000004','00000000-0000-0000-0000-000000000005','12345678','pbkdf2_sha256$260000$cmac_1234_2026$nhlxp2cx5uXJUEw0lgBkJ8tOY/jREMA0+ZGJZphlOGo=','cliente'),
('10000000-0000-0000-0000-000000000005','00000000-0000-0000-0000-000000000005','44455667','pbkdf2_sha256$260000$cmac_1234_2026$nhlxp2cx5uXJUEw0lgBkJ8tOY/jREMA0+ZGJZphlOGo=','cliente');
...
('40000000-0000-0000-0000-000000000001','10000000-0000-0000-0000-000000000004','12345678','Rodrigo','Arce Curi','2002-05-12','964111222','rodrigo.arce@mail.local','Av. Ferrocarril 123','A una cuadra del mercado Modelo','Junín','Huancayo','Huancayo',-12.0700200,-75.2108900,'soltero'),
('40000000-0000-0000-0000-000000000002','10000000-0000-0000-0000-000000000005','44455667','María','Quispe Huamán','1988-03-10','964222333','maria.quispe@mail.local','Jr. Arequipa 456','Casa color crema, segundo piso','Junín','Huancayo','El Tambo',-12.0514200,-75.2192400,'casada'),
('40000000-0000-0000-0000-000000000003',NULL,'41112233','José','Mamani Flores','1980-08-15','964333444','jose.mamani@mail.local','Av. Giráldez 789','Frente a galería comercial','Junín','Huancayo','Huancayo',-12.0677100,-75.2097200,'casado'),
('40000000-0000-0000-0000-000000000004',NULL,'42778899','Rosa','Condori Apaza','1992-01-21','964444555','rosa.condori@mail.local','Jr. Ica 234','Al costado de farmacia','Junín','Huancayo','Chilca',-12.0732600,-75.2052100,'soltera'),
('40000000-0000-0000-0000-000000000005',NULL,'43223344','Pedro','Ccahua Ramos','1975-11-02','964555666','pedro.ccahua@mail.local','Av. Huancavelica 345','Portón azul, taller mecánico','Junín','Huancayo','El Tambo',-12.0452600,-75.2153600,'casado');

INSERT INTO cliente_negocios (cliente_id, nombre_negocio, tipo_negocio, actividad_economica, antiguedad_meses, direccion_negocio, referencia_negocio, departamento, provincia, distrito, lat, lng, ubicacion_verificada, fuente_ubicacion, precision_ubicacion_metros, fecha_verificacion_ubicacion, usuario_verificacion_id, ingresos_estimados, gastos_estimados) VALUES
('40000000-0000-0000-0000-000000000001','Bodega Rodrigo','Comercio minorista','Bodega',24,'Av. Ferrocarril 123','A una cuadra del mercado Modelo','Junín','Huancayo','Huancayo',-12.0701000,-75.2110000,FALSE,'carga_inicial',NULL,NULL,NULL,4200,2600),
('40000000-0000-0000-0000-000000000002','Textiles María','Comercio textil','Textiles',60,'Jr. Arequipa 456','Galería textil, stand 12','Junín','Huancayo','El Tambo',-12.0510000,-75.2191000,FALSE,'carga_inicial',NULL,NULL,NULL,8500,5100),
('40000000-0000-0000-0000-000000000003','Ferretería Mamani','Ferretería','Comercio',72,'Av. Giráldez 789','Frente a galería comercial','Junín','Huancayo','Huancayo',-12.0679000,-75.2095000,FALSE,'carga_inicial',NULL,NULL,NULL,12000,7800),
('40000000-0000-0000-0000-000000000004','Juguería Rosa','Alimentos','Restaurante',18,'Jr. Ica 234','Al costado de farmacia','Junín','Huancayo','Chilca',-12.0730000,-75.2050000,FALSE,'carga_inicial',NULL,NULL,NULL,3800,2300),
('40000000-0000-0000-0000-000000000005','Taller Pedro','Servicios','Mecánica',96,'Av. Huancavelica 345','Portón azul, taller mecánico','Junín','Huancayo','El Tambo',-12.0450000,-75.2150000,FALSE,'carga_inicial',NULL,NULL,NULL,6500,4200);
...
('80000000-0000-0000-0000-000000000002','en_evaluacion','aprobado','10000000-0000-0000-0000-000000000002','Aprobación registrada');
...
('10000000-0000-0000-0000-000000000001','SEED','sistema',NULL,NULL,'Datos iniciales cargados correctamente');
